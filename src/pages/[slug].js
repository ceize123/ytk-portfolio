  ...
  return (
    <section className='work-page max-w-7xl mx-auto pb-24'>
      <div data-aos='fade-down'>
        <ImageTemplate
          url={`https:${banner.fields.file.url}`}
      ...
      <div className='md:hidden block sticky sm:top-20 top-12 py-4 text-center bg-primary'>
        ...
        {!mobileSupport && (
          <p className='text-sm mt-2 text-center text-red'>
        ...
        <aside className='col-span-2 mt-2'>
          <div className='md:sticky md:top-24 md:block flex justify-around'>
            ...
            <div className='md:mt-10 mt-0'>
              ...
              {tools.map((tool, idx) => {
                return (
                  <p key={idx} className='mt-2 text-base'>
                    {tool}
                  </p>
                );
              })}
            ...
            <div className='md:mt-10 hidden md:block'>
              ...
              {!mobileSupport && (
                <p className='text-sm w-2/3 mt-2 text-red'>
                  Mobile Devices not Supported
                </p>
              )}
            </div>
        ...
        <div className='col-span-6 grid grid-cols-1 gap-y-24 mt-16 md:mt-0'>
          ...
          <div>
            ...
            {execution.map((item, idx) => {
              return (
                <div
                  className={`${idx !== 0 ? 'mt-12' : 'mt-4'} border-l pl-5`}
                  key={idx}
                  data-aos='fade-up'
                >
                  <div>
            ...
            <div className='mt-4' data-aos='fade-up'>
              {result !== undefined ? (
                <video controls muted autoPlay loop>
                  <source
                    src={`https:${result[0].fields.file.url}`}
                    type='video/mp4'
                  />
                </video>
              ) : (
